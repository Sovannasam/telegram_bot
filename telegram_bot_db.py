...
REMINDER_DELAY_MINUTES = int(os.getenv("REMINDER_DELAY_MINUTES", "2")) # Delay for reminders
...
CLEARING_GROUP_ID = int(os.getenv("CLEARING_GROUP_ID", "-1002438185636")) # Group for auto-clearing pendings
...
ALLOWED_COUNTRIES = {
    ...
    'bulgaria', 'brazil', 'spain', 'belgium', 'portugal', 'netherlands', 'poland', 'france', 'argentina', 'costa rica',
